...
namespace OpenOverlays.Overlays.FlagPanel;
...
public partial class FlagPanel : Overlay
{
    ...
    public FlagPanel(): base("Flag Panel", "This Overlay shows the current flag state")
    {
        ...
        LoadEmbeddedImage(CheckeredFlag, "OpenOverlays.Overlays.FlagPanel.checkered_flag.png");
        LoadEmbeddedImage(DsqFlag, "OpenOverlays.Overlays.FlagPanel.dsq_flag.png");
        LoadEmbeddedImage(RepairFlag, "OpenOverlays.Overlays.FlagPanel.meetball_flag.png");
                LoadEmbeddedImage(DebrisFlag, "OpenOverlays.Overlays.FlagPanel.debris_flag.png");
        SetGreen();
